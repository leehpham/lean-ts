...
> {
  protected readonly _inputValidator: InputValidator<CreateTodoItemInputDto>;
  private readonly _repoCreate: CreateInMemRepo<TodoItemInMem>;

  public constructor(
    inputValidator: InputValidator<CreateTodoItemInputDto> = new CreateTodoItemInputValidator(),
